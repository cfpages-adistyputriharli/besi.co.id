---
article_id: BES-11-A05
title: "Detail Anti-Korosi: Drainage, Venting, Crevice, dan Water Trap"
slug: "detail-anti-korosi-struktur-baja"
description: "Show how geometry, sealed/vented spaces, drain paths, laps, welds, edges, access, and coating process affect durability"
status: outline
publication_date: "2026-03-29"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BES-11
primary_intent: "Improve corrosion-resistant detailing"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/detail-anti-korosi-struktur-baja.html"
...
# Detail Anti-Korosi: Drainage, Venting, Crevice, dan Water Trap

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Detail Anti-Korosi: Drainage, Venting, Crevice, dan Water Trap”
- **Reader and situation:** Designer or fabricator before production
- **Reader outcome:** Show how geometry, sealed/vented spaces, drain paths, laps, welds, edges, access, and coating process affect durability
- **Primary intent:** Improve corrosion-resistant detailing
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not design structure or galvanizing vents; BES-12-A03 and approved process own final details
- **Final public route:** `/artikel/detail-anti-korosi-struktur-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Detail Anti-Korosi: Drainage, Venting, Crevice, dan Water Trap**.
...
- `BES-11-A06` → `/artikel/inspeksi-dan-repair-coating-baja.html` — Inspeksi Coating dan Repair setelah Transport atau Erection
...
- **Tie back to this article:** Keep the explanation specific to “Detail Anti-Korosi: Drainage, Venting, Crevice, dan Water Trap”.
