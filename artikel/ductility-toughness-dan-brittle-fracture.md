---
article_id: BES-08-A02
title: "Ductility, Toughness, dan Brittle Fracture: Tiga Hal Berbeda"
slug: "ductility-toughness-dan-brittle-fracture"
description: "Explain deformation capacity, energy absorption, notch/temperature effects, thickness, restraint, welding, and required evidence"
status: outline
publication_date: "2026-01-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BES-08
primary_intent: "Distinguish failure-related properties"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/ductility-toughness-dan-brittle-fracture.html"
...
# Ductility, Toughness, dan Brittle Fracture: Tiga Hal Berbeda

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Ductility, Toughness, dan Brittle Fracture: Tiga Hal Berbeda”
- **Reader and situation:** Designer or owner in critical service
- **Reader outcome:** Explain deformation capacity, energy absorption, notch/temperature effects, thickness, restraint, welding, and required evidence
- **Primary intent:** Distinguish failure-related properties
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not set test temperature or fracture criteria; governing design basis owns values
- **Final public route:** `/artikel/ductility-toughness-dan-brittle-fracture.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Ductility, Toughness, dan Brittle Fracture: Tiga Hal Berbeda**.
...
- **Tie back to this article:** Keep the explanation specific to “Ductility, Toughness, dan Brittle Fracture: Tiga Hal Berbeda”.
