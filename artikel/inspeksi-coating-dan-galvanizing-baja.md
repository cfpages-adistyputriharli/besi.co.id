...
date_modified: null
parent_topic: BES-14
primary_intent: "Plan protection-system QA"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/inspeksi-coating-dan-galvanizing-baja.html"
...
- **Writer task:** Expand this file into one complete article answering: “Inspeksi Surface Preparation, Coating, dan Galvanizing”
- **Reader and situation:** Inspector checking protected steel
- **Reader outcome:** Cover substrate condition, environment, preparation, consumables/batches, application, cure, coverage, specified tests, damage, repair, and records
- **Primary intent:** Plan protection-system QA
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not set methods or values; approved coating specification owns acceptance
- **Final public route:** `/artikel/inspeksi-coating-dan-galvanizing-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Inspeksi Surface Preparation, Coating, dan Galvanizing**.
