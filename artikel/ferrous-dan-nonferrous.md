---
article_id: BES-01-A05
title: "Ferrous dan Nonferrous: Kapan “Logam” Bukan “Besi”"
slug: "ferrous-dan-nonferrous"
description: "Distinguish steel/cast iron from aluminum, copper, zinc, and other nonferrous families by decision attributes"
status: outline
publication_date: "2025-08-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BES-01
primary_intent: "Classify metal families"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/ferrous-dan-nonferrous.html"
...
# Ferrous dan Nonferrous: Kapan “Logam” Bukan “Besi”

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Ferrous dan Nonferrous: Kapan “Logam” Bukan “Besi””
- **Reader and situation:** General buyer choosing among metal options
- **Reader outcome:** Distinguish steel/cast iron from aluminum, copper, zinc, and other nonferrous families by decision attributes
- **Primary intent:** Classify metal families
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not compare every alloy or select one; BES-08-A01 owns project selection
- **Final public route:** `/artikel/ferrous-dan-nonferrous.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Ferrous dan Nonferrous: Kapan “Logam” Bukan “Besi”**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi WF 5](/wp-content/uploads/2024/01/Besi-WF-5.jpg)`
...
- **TOPIC-GATE:** G-01 for definitions/requirements beyond public scope; G-13 for test claims
...
- `/jual-pipa-besi-hitam-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pipa-besi-hitam-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pipa-besi-hitam-yahukimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pipa-besi-hitam-wonosobo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pipa-besi-hitam-wonogiri.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pipa-besi-hitam-way-kanan.html` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `BES-01-A03` → `/artikel/karbon-dan-unsur-paduan-baja.html` — Karbon dan Unsur Paduan: Mengapa Komposisi Mengubah Baja
- `BES-01-A04` → `/artikel/mikrostruktur-dan-heat-treatment-baja.html` — Mikrostruktur dan Heat Treatment Baja dalam Bahasa Praktis
- `BES-01-A06` → `/artikel/mitos-identifikasi-baja-dari-tampilan.html` — Mitos Identifikasi Baja dari Warna, Magnet, dan Percikan
...
- **Tie back to this article:** Keep the explanation specific to “Ferrous dan Nonferrous: Kapan “Logam” Bukan “Besi””.
