...
- **Writer task:** Expand this file into one complete article answering: “Section Properties: Area, Inersia, Modulus, dan Radius Gyration”
- **Reader and situation:** Reader using a profile table
- **Reader outcome:** Explain what area, centroid, moments of inertia, section modulus, torsion-related data, and radius of gyration represent
- **Primary intent:** Understand section-table fields
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not calculate structural capacity; BES-12-A02 owns member behavior/design
- **Final public route:** `/artikel/memahami-section-properties-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Section Properties: Area, Inersia, Modulus, dan Radius Gyration**.
...
- **Tie back to this article:** Keep the explanation specific to “Section Properties: Area, Inersia, Modulus, dan Radius Gyration”.
