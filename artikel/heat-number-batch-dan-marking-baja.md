...
date_modified: null
parent_topic: BES-02
primary_intent: "Preserve traceability"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/heat-number-batch-dan-marking-baja.html"
...
- **Writer task:** Expand this file into one complete article answering: “Heat Number, Batch, dan Marking: Rantai Identitas Material”
- **Reader and situation:** Warehouse or fabricator splitting stock
- **Reader outcome:** Explain heat/batch identity, physical marking, transfer during cutting, traveler records, remnants, and reconciliation
- **Primary intent:** Preserve traceability
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not set marking method; project QA plan in BES-14-A02 owns controls
- **Final public route:** `/artikel/heat-number-batch-dan-marking-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Heat Number, Batch, dan Marking: Rantai Identitas Material**.
