...
description: "Show mass from geometry, length, density assumption, unit conversion, and documented rounding for common form families"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Menghitung Berat Teoretis Produk Baja”
- **Reader and situation:** Estimator checking a quotation
- **Reader outcome:** Show mass from geometry, length, density assumption, unit conversion, and documented rounding for common form families
- **Primary intent:** Calculate theoretical mass
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not replace actual weighing or procurement allowance; BES-03-A04 owns reconciliation
- **Final public route:** `/artikel/menghitung-berat-teoretis-produk-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menghitung Berat Teoretis Produk Baja**.
...
- **Tie back to this article:** Keep the explanation specific to “Menghitung Berat Teoretis Produk Baja”.
