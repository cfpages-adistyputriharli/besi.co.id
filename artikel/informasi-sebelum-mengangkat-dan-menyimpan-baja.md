...
date_modified: null
parent_topic: BES-15
primary_intent: "Prepare handling/storage plan"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/informasi-sebelum-mengangkat-dan-menyimpan-baja.html"
...
- **Reader and situation:** Logistics and warehouse team
- **Reader outcome:** Gather verified mass, package geometry, center of gravity, lifting points, edge/rolling hazards, restraints, supports, coating, segregation, weather, and access
- **Primary intent:** Prepare handling/storage plan
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not select rigging or stack limits; competent lift/storage plan owns controls
- **Final public route:** `/artikel/informasi-sebelum-mengangkat-dan-menyimpan-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Informasi Wajib Sebelum Mengangkat dan Menyimpan Baja**.
