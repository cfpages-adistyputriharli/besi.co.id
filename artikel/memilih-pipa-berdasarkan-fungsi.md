...
description: "Map fluid, pressure/temperature, corrosion, cleanliness, joining, inspection, support, code, and traceability versus structural/conduit needs"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Memilih Pipa untuk Tekanan, Struktur, atau Conduit”
- **Reader and situation:** Buyer starting from an application
- **Reader outcome:** Map fluid, pressure/temperature, corrosion, cleanliness, joining, inspection, support, code, and traceability versus structural/conduit needs
- **Primary intent:** Define pipe-system requirements
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not size or rate a pipe; responsible system designer owns design
- **Final public route:** `/artikel/memilih-pipa-berdasarkan-fungsi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Pipa untuk Tekanan, Struktur, atau Conduit**.
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Pipa untuk Tekanan, Struktur, atau Conduit”.
