...
date_modified: null
parent_topic: BES-04
primary_intent: "Decode hollow product labels"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/hollow-hitam-galvanis-dan-galvalum.html"
...
- **Writer task:** Expand this file into one complete article answering: “Hollow Hitam, Galvanis, dan Galvalum: Pisahkan Bentuk dari Pelapis”
- **Reader and situation:** Buyer comparing hollow listings
- **Reader outcome:** Separate section geometry, base material, manufacturing route, zinc-based coating terms, dimensions, and evidence
- **Primary intent:** Decode hollow product labels
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not promise corrosion life or grade; BES-11-A04 and BES-02-A01 own those claims
- **Final public route:** `/artikel/hollow-hitam-galvanis-dan-galvalum.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Hollow Hitam, Galvanis, dan Galvalum: Pisahkan Bentuk dari Pelapis**.
...
- **Exact Markdown to insert:** `![Ilustrasi hollow hitam](/wp-content/uploads/2024/05/hollow-hitam.jpeg)`
