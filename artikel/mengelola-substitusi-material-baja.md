...
description: "Document original requirement, proposed change, reason, full comparison, design/process/inspection impacts, stakeholders, approval, and records"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Mengelola Substitusi dan Deviation Request Material Baja”
- **Reader and situation:** Project team facing unavailable stock
- **Reader outcome:** Document original requirement, proposed change, reason, full comparison, design/process/inspection impacts, stakeholders, approval, and records
- **Primary intent:** Control proposed deviations
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not approve equivalence; BES-02-A04 and responsible designer own technical acceptance
- **Final public route:** `/artikel/mengelola-substitusi-material-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengelola Substitusi dan Deviation Request Material Baja**.
...
- **Tie back to this article:** Keep the explanation specific to “Mengelola Substitusi dan Deviation Request Material Baja”.
