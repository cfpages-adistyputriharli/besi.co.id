...
date_modified: null
parent_topic: BES-08
primary_intent: "Understand fatigue risk"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/fatigue-baja-dan-beban-berulang.html"
...
- **Writer task:** Expand this file into one complete article answering: “Fatigue Baja: Mengapa Beban Berulang Bisa Mengalahkan Beban Kecil”
- **Reader and situation:** Owner of cyclically loaded equipment/structure
- **Reader outcome:** Explain stress ranges, cycles, notches, weld details, corrosion, residual stress, inspection, and change history conceptually
- **Primary intent:** Understand fatigue risk
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not calculate fatigue life; BES-12-A04 and competent engineer own assessment
- **Final public route:** `/artikel/fatigue-baja-dan-beban-berulang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Fatigue Baja: Mengapa Beban Berulang Bisa Mengalahkan Beban Kecil**.
