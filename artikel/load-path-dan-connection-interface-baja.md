...
- **Writer task:** Expand this file into one complete article answering: “Load Path dan Connection Interface pada Struktur Baja”
- **Reader and situation:** Owner reviewing connection completeness
- **Reader outcome:** Follow loads through members, plates, welds/bolts, anchors, concrete/host structure, bracing, and temporary supports
- **Primary intent:** Trace force transfer
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not size connections or anchors; licensed design owns details
- **Final public route:** `/artikel/load-path-dan-connection-interface-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Load Path dan Connection Interface pada Struktur Baja**.
...
- **Tie back to this article:** Keep the explanation specific to “Load Path dan Connection Interface pada Struktur Baja”.
