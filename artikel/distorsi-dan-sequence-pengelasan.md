...
- **Writer task:** Expand this file into one complete article answering: “Distorsi, Residual Stress, dan Sequence Pengelasan”
- **Reader and situation:** Fabricator assembling a frame
- **Reader outcome:** Explain heat/shrinkage, restraint, joint sequence, balance, fit-up, preset/trial, measurement, and controlled correction concepts
- **Primary intent:** Plan distortion control
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not prescribe sequence or straightening; approved fabrication procedure owns it
- **Final public route:** `/artikel/distorsi-dan-sequence-pengelasan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Distorsi, Residual Stress, dan Sequence Pengelasan**.
...
- **Tie back to this article:** Keep the explanation specific to “Distorsi, Residual Stress, dan Sequence Pengelasan”.
