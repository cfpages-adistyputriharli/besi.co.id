...
- **Writer task:** Expand this file into one complete article answering: “INP, UNP, dan CNP: Kanal yang Tidak Boleh Dipertukarkan dari Nama”
- **Reader and situation:** Detailer selecting a channel family
- **Reader outcome:** Explain geometry, symmetry, lips, production route, axes, connection access, and torsional implications conceptually
- **Primary intent:** Compare channel profiles
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not size a channel or approve substitution; BES-12-A02 owns design
- **Final public route:** `/artikel/inp-unp-dan-cnp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **INP, UNP, dan CNP: Kanal yang Tidak Boleh Dipertukarkan dari Nama**.
...
- `/jual-unp-wonogiri.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “INP, UNP, dan CNP: Kanal yang Tidak Boleh Dipertukarkan dari Nama”.
