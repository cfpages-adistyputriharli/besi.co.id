...
description: "Show why appearance, magnet response, spark, and seller label are screening clues rather than proof of grade"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Mitos Identifikasi Baja dari Warna, Magnet, dan Percikan”
- **Reader and situation:** Workshop or buyer lacking traceability
- **Reader outcome:** Show why appearance, magnet response, spark, and seller label are screening clues rather than proof of grade
- **Primary intent:** Avoid unsafe identification shortcuts
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not teach a substitute test; BES-02-A06 and BES-14-A03 own verification
- **Final public route:** `/artikel/mitos-identifikasi-baja-dari-tampilan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mitos Identifikasi Baja dari Warna, Magnet, dan Percikan**.
...
- **Tie back to this article:** Keep the explanation specific to “Mitos Identifikasi Baja dari Warna, Magnet, dan Percikan”.
